...
public class PrincipalApp extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener  {
    private static final String TAG = "SignInActivity";
    private static final int RC_SIGN_IN = 9001;

    private GoogleApiClient mGoogleApiClient;
    public TextView mStatusTextView;
    public TextView mCorreoTextView;
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            nombre = (String) mStatusTextView.getText();
            updateUI(true);
        } else {
    ...
    private void signOut() {
       ...
       // tarea.execute();
        Intent intent = new Intent (getApplicationContext(), MostraInfo.class);
        String auxEdiNombre=mStatusTextView.getText().toString();
            intent.putExtra("nombre",auxEdiNombre);
        startActivity(intent);
    }
    private void cargar() {
        Intent intent = new Intent(getApplicationContext(), altaDatos.class);
